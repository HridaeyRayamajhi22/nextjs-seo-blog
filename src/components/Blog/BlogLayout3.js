    ...
    <div className="flex flex-col w-full text-dark">
      ...
      <div className="w-full mt-4 flex flex-col items-start">
        ...
        <Link href={blog.url} className="inline-block mt-1">
          <h3 className="capitalize text-base sm:text-lg font-semibold text-accentDark-300 leading-snug dark:text-light">
        ...
        {/* Date */}
        <span className="capitalize text-dark/50 font-medium text-xs sm:text-sm mt-1 dark:text-gray">
